  ...
  return (
    ...
    >
      ...
      <div style={{ display: "grid", gap: "0.25rem", color: "#94a3b8" }}>
        ...
        <span>
          Second non-alert protected read slice: {diagnostics.auth.secondaryNonAlertsProtectedReadSliceLabel ?? diagnostics.session.secondaryNonAlertsReadGuardedSliceLabel ?? "none"} / Enforced:{" "}
          {(diagnostics.auth.secondaryNonAlertsProtectedReadSliceEnforced ?? diagnostics.session.secondaryNonAlertsReadGuardedSliceEnforced) ? "yes" : "no"}
        </span>
        <span>
          Third non-alert protected read slice: {diagnostics.auth.tertiaryNonAlertsProtectedReadSliceLabel ?? diagnostics.session.tertiaryNonAlertsReadGuardedSliceLabel ?? "none"} / Enforced:{" "}
          {(diagnostics.auth.tertiaryNonAlertsProtectedReadSliceEnforced ?? diagnostics.session.tertiaryNonAlertsReadGuardedSliceEnforced) ? "yes" : "no"}
        </span>
        <span>
          Fourth non-alert protected read slice: {diagnostics.auth.quaternaryNonAlertsProtectedReadSliceLabel ?? diagnostics.session.quaternaryNonAlertsReadGuardedSliceLabel ?? "none"} / Enforced:{" "}
        ...
        <span>
          Sixth non-alert protected read slice: {diagnostics.auth.senaryNonAlertsProtectedReadSliceLabel ?? diagnostics.session.senaryNonAlertsReadGuardedSliceLabel ?? "none"} / Enforced:{" "}
          {(diagnostics.auth.senaryNonAlertsProtectedReadSliceEnforced ?? diagnostics.session.senaryNonAlertsReadGuardedSliceEnforced) ? "yes" : "no"}
        </span>
        <span>
        ...
        <span>
          Fifth non-alert protected slice: {diagnostics.auth.quinaryNonAlertsProtectedSliceLabel ?? diagnostics.session.quinaryNonAlertsGuardedSliceLabel ?? "none"} / Enforced:{" "}
          {diagnostics.auth.quinaryNonAlertsProtectedSliceEnforced || diagnostics.session.quinaryNonAlertsGuardedSliceEnforced ? "yes" : "no"}
        </span>
        <span>
          Sixth non-alert protected slice: {diagnostics.auth.senaryNonAlertsProtectedSliceLabel ?? diagnostics.session.senaryNonAlertsGuardedSliceLabel ?? "none"} / Enforced:{" "}
        ...
        <span>
          Eighth non-alert protected slice: {diagnostics.auth.octonaryNonAlertsProtectedSliceLabel ?? diagnostics.session.octonaryNonAlertsGuardedSliceLabel ?? "none"} / Enforced:{" "}
          {diagnostics.auth.octonaryNonAlertsProtectedSliceEnforced || diagnostics.session.octonaryNonAlertsGuardedSliceEnforced ? "yes" : "no"}
        </span>
        <span>
      ...
      <div style={{ display: "grid", gap: "0.25rem", color: "#cbd5e1" }}>
        ...
        {backendProbe?.runtime?.auth ? (
          <span>
            Backend second non-alert protected read slice: {backendProbe.runtime.auth.secondaryNonAlertsProtectedReadSliceLabel ?? "none"} / Enforced:{" "}
            {backendProbe.runtime.auth.secondaryNonAlertsProtectedReadSliceEnforced ? "yes" : "no"}
          </span>
        ) : null}
        {backendProbe?.runtime?.auth ? (
          <span>
            Backend third non-alert protected read slice: {backendProbe.runtime.auth.tertiaryNonAlertsProtectedReadSliceLabel ?? "none"} / Enforced:{" "}
            {backendProbe.runtime.auth.tertiaryNonAlertsProtectedReadSliceEnforced ? "yes" : "no"}
          </span>
        ) : null}
        {backendProbe?.runtime?.auth ? (
          <span>
        ...
        {backendProbe?.runtime?.auth ? (
          <span>
            Backend sixth non-alert protected read slice: {backendProbe.runtime.auth.senaryNonAlertsProtectedReadSliceLabel ?? "none"} / Enforced:{" "}
            {backendProbe.runtime.auth.senaryNonAlertsProtectedReadSliceEnforced ? "yes" : "no"}
          </span>
        ) : null}
        {backendProbe?.runtime?.auth ? (
          <span>
        ...
        {backendProbe?.runtime?.auth ? (
          <span>
            Backend fifth non-alert protected slice: {backendProbe.runtime.auth.quinaryNonAlertsProtectedSliceLabel ?? "none"} / Enforced:{" "}
            {backendProbe.runtime.auth.quinaryNonAlertsProtectedSliceEnforced ? "yes" : "no"}
          </span>
        ) : null}
        {backendProbe?.runtime?.auth ? (
          <span>
        ...
        {backendProbe?.runtime?.auth ? (
          <span>
            Backend eighth non-alert protected slice: {backendProbe.runtime.auth.octonaryNonAlertsProtectedSliceLabel ?? "none"} / Enforced:{" "}
            {backendProbe.runtime.auth.octonaryNonAlertsProtectedSliceEnforced ? "yes" : "no"}
          </span>
        ) : null}
        {backendProbe?.runtime ? (
          <span>
        ...
        {backendProbe?.runtime?.aiHistory?.supportedReuseDestinations?.length ? (
          <span>
            AI history reuse destinations: {backendProbe.runtime.aiHistory.supportedReuseDestinations.join(", ")}
          </span>
        ) : null}
        {backendProbe?.runtime ? (
          <span>
