...
export function createEndpointHandlerRegistry(handlers: EndpointHandlers) {
  return {
    ...
    [endpointInvocationRegistry.alerts.resolve.endpointId]: handlers.alerts.resolve,
    [endpointInvocationRegistry.alerts.bulkResolve.endpointId]: handlers.alerts.bulkResolve,
    [endpointInvocationRegistry.alerts.assign.endpointId]: handlers.alerts.assign,
    [endpointInvocationRegistry.alerts.bulkAssign.endpointId]: handlers.alerts.bulkAssign,
    [endpointInvocationRegistry.alerts.unassign.endpointId]: handlers.alerts.unassign,
    [endpointInvocationRegistry.alerts.setReviewState.endpointId]: handlers.alerts.setReviewState,
    [endpointInvocationRegistry.alerts.bulkSetReviewState.endpointId]: handlers.alerts.bulkSetReviewState,
