...
export function getAuthRuntimeDiagnostics(
  ...
  return {
    ...
    nonAlertsReadAccessSummaryEnforced: effectiveMode === "keycloak",
    nonAlertsProtectedReadSliceLabel: "water_quality_detail_read",
    nonAlertsProtectedReadSliceEnforced: effectiveMode === "keycloak",
    ...
    quinaryNonAlertsProtectedReadSliceEnforced: effectiveMode === "keycloak",
    senaryNonAlertsProtectedReadSliceLabel: "feed_recent_read",
    senaryNonAlertsProtectedReadSliceEnforced: effectiveMode === "keycloak",
    ...
    senaryNonAlertsProtectedSliceEnforced: effectiveMode === "keycloak",
    septenaryNonAlertsProtectedSliceLabel: "tasks_create",
    septenaryNonAlertsProtectedSliceEnforced: effectiveMode === "keycloak",
    octonaryNonAlertsProtectedSliceLabel: "ponds_create",
    octonaryNonAlertsProtectedSliceEnforced: effectiveMode === "keycloak",
    forwardingMode,
