...
export const endpointInvocationRegistry = {
  ...
  alerts: {
    ...
    summary: defineEndpointInvocationConfig(aquaPulseEndpointCatalog.alerts.summary),
    ...
    bulkResolve: defineEndpointInvocationConfig(aquaPulseEndpointCatalog.alerts.bulkResolve),
    assign: defineEndpointInvocationConfig(aquaPulseEndpointCatalog.alerts.assign),
    bulkAssign: defineEndpointInvocationConfig(aquaPulseEndpointCatalog.alerts.bulkAssign),
    ...
    bulkSetReviewState: defineEndpointInvocationConfig(aquaPulseEndpointCatalog.alerts.bulkSetReviewState),
...
export function flattenEndpointInvocationRegistry(registry: EndpointInvocationRegistry) {
  return {
    ...
    [registry.alerts.summary.endpointId]: registry.alerts.summary,
    ...
    [registry.alerts.bulkResolve.endpointId]: registry.alerts.bulkResolve,
    [registry.alerts.assign.endpointId]: registry.alerts.assign,
    [registry.alerts.bulkAssign.endpointId]: registry.alerts.bulkAssign,
    ...
    [registry.alerts.bulkSetReviewState.endpointId]: registry.alerts.bulkSetReviewState,
