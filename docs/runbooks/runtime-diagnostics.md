...
- `aiOperatorAssistance.mode = fallback` means daily farm summary, shift handover, and dashboard assistant are running on the deterministic backend fallback path
